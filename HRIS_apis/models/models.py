...
class StaffLeaveRequest(db.Model):
    ...
    Holiday_Date = db.Column(db.DateTime, nullable=True)
...
class StudentSubmissions_JotForm(db.Model):
    ...
    IfPrivate = db.Column(db.Text, nullable=True)
    LevelStudied = db.Column(db.Text, nullable=True)
    NameOfCurrentSchool = db.Column(db.Text, nullable=True)
    NameOfCurrentSchoolOther = db.Column(db.Text, nullable=True)
    BirthDate = db.Column(db.Date, nullable=True)
    Religion = db.Column(db.Text, nullable=True)
    Nationality = db.Column(db.Text, nullable=True)
    CNIC_BFormNumber = db.Column(db.Text, nullable=True)
    Country = db.Column(db.Text, nullable=True)
    PassportNumber = db.Column(db.Text, nullable=True)
    ...
    PassportSizePhotograph = db.Column(db.Text, nullable=True)
    FathersGuardianFullName = db.Column(db.Text, nullable=True)
    SameAsMineFather = db.Column(db.Boolean, nullable=True)
    FathersAddress = db.Column(db.Text, nullable=True)
    FatherCNICNumber = db.Column(db.Text, nullable=True)
    FatherEmail = db.Column(db.Text, nullable=True)
    FatherPhoneNumber = db.Column(db.Text, nullable=True)
    FatherOccupation = db.Column(db.Text, nullable=True)
    FatherCompanyName = db.Column(db.Text, nullable=True)
    MothersFullName = db.Column(db.Text, nullable=True)
    SameAsMineMother = db.Column(db.Boolean, nullable=True)
    MothersAddress = db.Column(db.Text, nullable=True)
    MotherCNICNumber = db.Column(db.Text, nullable=True)
    MotherEmail = db.Column(db.Text, nullable=True)
    MotherPhoneNumber = db.Column(db.Text, nullable=True)
    MotherOccupation = db.Column(db.Text, nullable=True)
    MotherCompanyName = db.Column(db.Text, nullable=True)
    PakStudies = db.Column(db.Text, nullable=True)
    Islamiat = db.Column(db.Text, nullable=True)
    UrduSyllabusB = db.Column(db.Text, nullable=True)
    Other1 = db.Column(db.Text, nullable=True)
    Other1Grade = db.Column(db.Text, nullable=True)
    Other2 = db.Column(db.Text, nullable=True)
    Other2Grade = db.Column(db.Text, nullable=True)
    Other3 = db.Column(db.Text, nullable=True)
    Other3Grade = db.Column(db.Text, nullable=True)
    OLevelSubjects = db.Column(db.Text, nullable=True)
    OLevelGroup = db.Column(db.Text, nullable=True)
    ALevelGroup = db.Column(db.Text, nullable=True)
    ASSubject1 = db.Column(db.Text, nullable=True)
    SubjectTeacherPreference1 = db.Column(db.Text, nullable=True)
    SubjectTeacherPreference2 = db.Column(db.Text, nullable=True)
    ASSubject2 = db.Column(db.Text, nullable=True)
    SubjectTeacherPreference1_2 = db.Column(db.Text, nullable=True)
    SubjectTeacherPreference2_2 = db.Column(db.Text)
    ASSubject3 = db.Column(db.Text, nullable=True)
    SubjectTeacherPreference1_3 = db.Column(db.Text, nullable=True)
    SubjectTeacherPreference2_3 = db.Column(db.Text, nullable=True)
    ASSubject4 = db.Column(db.Text, nullable=True)
    SubjectTeacherPreference1_4 = db.Column(db.Text, nullable=True)
    SubjectTeacherPreference2_4 = db.Column(db.Text, nullable=True)
    ASSubject5 = db.Column(db.Text, nullable=True)
    SubjectTeacherPreference1_5 = db.Column(db.Text, nullable=True)
    SubjectTeacherPreference2_5 = db.Column(db.Text, nullable=True)
    ...
    Sports1 = db.Column(db.Text, nullable=True)
    OtherSport1 = db.Column(db.Text, nullable=True)
    Sports1Level = db.Column(db.Text, nullable=True)
    Sports1Description = db.Column(db.Text, nullable=True)
    Sports2 = db.Column(db.Text, nullable=True)
    OtherSport2 = db.Column(db.Text, nullable=True)
    Sports2Level = db.Column(db.Text, nullable=True)
    Sports2Description = db.Column(db.Text, nullable=True)
    Sports3 = db.Column(db.Text, nullable=True)
    OtherSport3 = db.Column(db.Text, nullable=True)
    Sports3Level = db.Column(db.Text, nullable=True)
    Sports3Description = db.Column(db.Text, nullable=True)
    Debates = db.Column(db.Text, nullable=True)
    DebatesLevel = db.Column(db.Text, nullable=True)
    DebatesDescription = db.Column(db.Text, nullable=True)
    OtherDebates = db.Column(db.Text, nullable=True)
    OtherDescription = db.Column(db.Text, nullable=True)
    ReferenceName1 = db.Column(db.Text, nullable=True)
    ReferenceContactNumber1 = db.Column(db.Text, nullable=True)
    ReferenceName2 = db.Column(db.Text, nullable=True)
    ReferenceContactNumber2 = db.Column(db.Text, nullable=True)
    ReferenceName3 = db.Column(db.Text, nullable=True)
    ReferenceContactNumber3 = db.Column(db.Text, nullable=True)
    AlphaID = db.Column(db.Text, nullable=True)
    ReferenceContactNumber4 = db.Column(db.Text, nullable=True)
